...
class CAE(object):
    ...
    def train(self, epochs=200, learning_rate=1e-3, plot_loss=False, batch_size=512):
        ...
        for epoch in range(epochs):
            ...
            if epoch % 10 == 0:
                print("epoch : {}/{}, training loss = {:.8f}, recon loss = {:.8f}, distance loss = {:.8f}".format(epoch,
                                                                                                                  epochs,
                                                                                                                  loss,
                                                                                                                  recon_loss_epoch,
                                                                                                                  distance_loss_epoch))
    ...
    def test(self, batch_size):
        ...
        print(
            "Test: loss = {:.8f}, recon loss = {:.8f}, distance loss = {:.8f}".format(loss, recon_loss, distance_loss))
