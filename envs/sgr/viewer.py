...
class Viewer:
    ...
    def __init__(self, env_width, env_height, width=700, height=700,
                 background=(0, 0, 0)):
        """
        Constructor.
    ...
    def line(self, start, end, color=(255, 255, 255), width=1):
        ...
        pygame.draw.line(self.screen, color, start, end, int(width * self._ratio[0]))
    ...
    def display(self, s, path):
        ...
        # Need this in order to render properly on Mac OS Mojave
